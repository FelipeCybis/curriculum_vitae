...
#let experiences = {
  ...
  resume-item[
    ...
    - #underline(offset: 2pt)[Techniques:] *_Drosophila melanogaster_ rearing ‑
      Immunostaining ‑ Confocal microscopy ‑ Ethological analysis ‑ Survival and Dietary
      assays ‑ Drosophila Activity Monitoring (DAM) system*
  ]
